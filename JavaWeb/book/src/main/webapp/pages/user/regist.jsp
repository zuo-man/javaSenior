	...
	<head>
		...
		<script type="text/javascript">
			...
			$(function () {
				...
				//失去焦点事件blur，使用Ajax请求 验证用户名是否已存在
...
<%--											使用EL表达式--%>
									...
									<input class="itxt" type="text" name="code" style="width: 80px;" id="code"
											<%-- value="<%=request.getAttribute("captcha") == null? "" : request.getAttribute("captcha")%>" --%>
									/>
